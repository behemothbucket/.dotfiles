...
vim.api.nvim_set_hl(0, "DiffAdd", { fg = gruber_darker_green, bg = "NONE" })
vim.api.nvim_set_hl(0, "DiffAdded", { link = "DiffAdd" })
vim.api.nvim_set_hl(0, "DiffChange", { fg = gruber_darker_brown, bg = "NONE" })
vim.api.nvim_set_hl(0, "DiffChanged", { link = "DiffChange" })
vim.api.nvim_set_hl(0, "DiffDelete", { fg = gruber_darker_red, bg = "NONE" })
vim.api.nvim_set_hl(0, "DiffRemoved", { link = "DiffDelete" })
vim.api.nvim_set_hl(0, "DiffText", { fg = gruber_darker_quartz })

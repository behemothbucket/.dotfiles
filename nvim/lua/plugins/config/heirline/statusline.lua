...
local icons = require("plugins.config.heirline.common").icons
local separators = require("plugins.config.heirline.common").separators
local dim = require("plugins.config.heirline.common").dim
